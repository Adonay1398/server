...
prompt_templates_f_o = """Genera {type_report}(tipo de reporte) tomando como referencia los siguientes datos, que van del 0 al 100:
...
Siempre genera la respuesta en **formato JSON** con las claves `fortaleza` y `oportunidad`. Usa formato Markdown para resaltar los identificadores con **negritas**. Genera un reporte sin usar frases como "En base a los datos proporcionados".
...
prompt_templates_p_i = """Genera {type_report}(tipo de reporte) tomando como referencia los siguientes datos, que van del 0 al 100:
